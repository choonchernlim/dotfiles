...
# One line: model, directory, git branch, threshold-colored context bar,
# session cost, and duration. Managed here in dotfiles; referenced by
# settings/claude.json (statusLine.command).
input=$(cat)
